...
The Windows installer can set up:

- the local AxiOwl runtime;
- provider MCP config;
- bridge extensions for supported editor surfaces;
- selected provider patches where required;
